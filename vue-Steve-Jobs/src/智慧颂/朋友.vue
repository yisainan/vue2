                    ...
                    <li class="mui-table-view-cell mui-media" v-for="db in news" @tap="link(db)">
                        <a>
                            ...
                            <div class="mui-media-body">
                                <h4>朋友和朋友 <span class="stage">第{{db.stage}}期</span></h4>
                                {{db.title}}
                            </div>
                        </a>
                    </li>
...
<style scoped>
    .cates { margin: 8px 0 10px 8px; }
        .cates a.mui-slider-item { width: auto; text-align: center; display: inline-block; padding: 0px 10px; margin-top: 8px; font-size: 15px; color: #666465; }
        .cates a:not(:first-child) { border-left: 1px solid #CFCFCF; }
        .cates a.on { color: #3C5870; }
      .fbjbox2{background: #EBEBEB;}  
    /*100*60*/
    .stage { color: #030303; font-size: 12px; }
   .list h4 { color: #082E53; }
.no-content   img{width: 30%}
.no-content h4{font-family: "微软雅黑";margin-top: 0px;font-size: 16px;}
    .mui-table-view .mui-media-object { line-height: 60px; max-width: 100px; height: 60px; }
